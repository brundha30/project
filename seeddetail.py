...
label_0 = Label(top,text="View Seed Detail",width=30,font=("bold",30))
...
tree = ttk.Treeview(sideViewForm,columns=("Id","Seed_Name","Cost_Range","Description"),selectmode="extended", height=20, yscrollcommand=scrollbary.set, xscrollcommand=scrollbarx.set)
