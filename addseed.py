# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 12:45:51 2022
...
def database():
    seedid1=seed_id.get()
    seedname1=seed_name.get()
    costrange1=cost_range.get()
    description1=description.get()
    conn=sqlite3.connect('project.db')
    with conn:
        cursor=conn.cursor()
    cursor.execute('INSERT INTO addseed (Seed_ID,Seed_Name,Cost_Range,Description,Photo) VALUES(?,?,?,?,?)',(seedid1,seedname1,costrange1,description1,blob_data))
    conn.commit()
