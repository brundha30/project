# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 18:20:36 2022
...
label_0 = Label(top,text="View Insecticide Detail",width=30,font=("bold",30))
...
tree = ttk.Treeview(sideViewForm,columns=("Id","Insecticide_Name","Cost_Range","Description"),selectmode="extended", height=20, yscrollcommand=scrollbary.set, xscrollcommand=scrollbarx.set)
