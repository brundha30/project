# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 12:29:43 2022
...
def database():
    ...
    with conn:
        cursor=conn.cursor()
    cursor.execute('INSERT INTO addcrop (Crop_ID,Crop_Name,Cost_Range,Description,Photo) VALUES(?,?,?,?,?)',(cropid1,cropname1,costrange1,description1,blob_data))
    conn.commit()
